...
$(function() {
    function ShowNotif(data) {
        ...
        if (data.type === 'baduabierto') {
            ...
            imagen = "https://media.discordapp.net/attachments/964949852775677984/975830976037007400/unknown.png";
        } else if (data.type === 'vanillaabierto') {
            imagen = "https://media.discordapp.net/attachments/964949852775677984/976210407238828052/unknown.png?width=493&height=657";
        } else if (data.type === 'vanillacerrado') {
            imagen = "https://media.discordapp.net/attachments/964949852775677984/976210407238828052/unknown.png?width=493&height=657";
        } else if (data.type === 'cpabierto') {
            imagen = "https://media.discordapp.net/attachments/964949852775677984/976211746673033276/unknown.png";
        } else if (data.type === 'cpcerrado') {
            imagen = "https://media.discordapp.net/attachments/964949852775677984/976211746673033276/unknown.png";
        }
